...
export default {
  ...
  oficinaBtn: 'body > div:nth-child(3) > div > main > div > div > div > div > div:nth-child(1) > div > div > div > div > div > div > div > div.container-fluid.h-100 > div > div > div > button:nth-child(2)',

  modal1: 'body > div:nth-child(3) > div > main > div > div > div > div > div.background > div:nth-child(2) > div:nth-child(2) > div > div > div > div > div > a > span > svg',
  ...
  inputEstado: '#vs2__combobox > div.vs__selected-options > input',

  selectOficina: 'body > div:nth-child(3) > div.container > div:nth-child(3) > div > div > div > div:nth-child(2) > div:nth-child(1) > form > div:nth-child(3) > div:nth-child(3) > div.inputcontainer > div > div',

  inputOficina: '#vs3__combobox > div.vs__selected-options > input',

  seleccionarBtn: 'body > div:nth-child(3) > div.container > div:nth-child(3) > div > div > div > div:nth-child(2) > div:nth-child(1) > form > div:nth-child(4) > div > div:nth-child(3) > div > div > div > div.card-body > div > center > a',

  modal5: 'body > div:nth-child(3) > div.container > div:nth-child(3) > div > div > div > div:nth-child(2) > div:nth-child(1) > form > div:nth-child(4) > div > div:nth-child(1) > div > div > div > div > div > div > div.container-fluid.h-100 > div > div > div > button.btn.btn-primary.btn-sm',

  agregarLink: 'body > div:nth-child(3) > div.container > div:nth-child(3) > div > div > div > div:nth-child(2) > div:nth-child(1) > form > div:nth-child(5) > div > div > div > div.form-group.col-md-12 > div > div.panel.panel-default > div > div > div:nth-child(4) > a',

  inputNombre: 'body > div:nth-child(3) > div.container > div:nth-child(3) > div > div > div > div:nth-child(2) > div:nth-child(1) > form > div:nth-child(5) > div > div > div > div:nth-child(3) > form > div:nth-child(1) > div:nth-child(1) > div > input',

  inputApellido: 'body > div:nth-child(3) > div.container > div:nth-child(3) > div > div > div > div:nth-child(2) > div:nth-child(1) > form > div:nth-child(5) > div > div > div > div:nth-child(3) > form > div:nth-child(1) > div:nth-child(2) > div > input',

  inputNac: 'body > div:nth-child(3) > div.container > div:nth-child(3) > div > div > div > div:nth-child(2) > div:nth-child(1) > form > div:nth-child(5) > div > div > div > div:nth-child(3) > form > div:nth-child(2) > div:nth-child(3) > div > div > div',
